...
export default function CardFeedback({
  ...
  return (
    <div className="size-full h-96 flex flex-col gap-4 p-4 rounded-2xl max-w-[500px] bg-[#FFF9FD] max-h-[230px] dark:shadow-dark-shadow-feedback shadow-light-shadow-feedback shadow-md">
